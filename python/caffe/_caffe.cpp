...
struct CaffeNet {
  ...
  void set_input_arrays(object data_obj, object labels_obj) {
    ...
    check_contiguous_array(labels_arr, "labels array", md_layer->targets(), 1, 1);
...
class CaffeSGDSolver {
 public:
  ...
  void Snapshot() { solver_->Snapshot();}//my code
...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  boost::python::class_<CaffeBlob, CaffeBlobWrap>(
      ...
      .add_property("rms",     &CaffeBlobWrap::get_rms)
  ...
  boost::python::class_<CaffeSGDSolver, boost::noncopyable>(
      ...
      .add_property("iter", &CaffeSGDSolver::iter)
